...
#	BaseRequete = "http://dcpc-nwp.meteo.fr/services/PS_GetCache_DCPCPreviNum?token=__5yLVTdr-sGeHoPitnFc7TZ6MhBcJxuSsoZp6y0leVHU__&model=AROME&grid=0.01&format=grib2"
	...
	BaseRequete = "http://dcpc-nwp.meteo.fr/services/PS_GetCache_DCPCPreviNum?token="+ monNouveauToken + "&model=AROME&grid=0.01&grid2=0.01&format=grib2"
...
#			for chunk in RawData:
			for chunk in RawData.iter_content(10000):
				Taille = Taille + 1000
